  ...
  )
{
  ...
  {
    {.x = Ring2_Boolean_False,.y = Ring2_Boolean_False,.z = Ring2_Boolean_True  },
    ...
    {.x = Ring2_Boolean_True,.y = Ring2_Boolean_True,.z = Ring2_Boolean_True  },
  };
  ...
  for (size_t i = 0, n = numberOfSpecificiations; i < n; ++i)
  {
    ...
    Mkx_Interpreter_Instructions_lowerThanOrEqualTo(context);
...
{
  testLowerThanOrEqualToBoolean(context);
  testLowerThanOrEqualToInteger(context);
  testLowerThanOrEqualToReal(context);
}
