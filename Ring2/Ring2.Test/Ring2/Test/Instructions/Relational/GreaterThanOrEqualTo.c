  ...
  )
{
  ...
  for (size_t i = 0, n = numberOfSpecificiations; i < n; ++i)
  {
    ...
    Mkx_Interpreter_Instructions_greaterThanOrEqualTo(context);
...
static void
testGreaterThanOrEqualToInteger
  (
    Ring2_Context* context
  )
{
...
{
  testGreaterThanOrEqualToBoolean(context);
  testGreaterThanOrEqualToInteger(context);
  testGreaterThanOrEqualToReal(context);
}
