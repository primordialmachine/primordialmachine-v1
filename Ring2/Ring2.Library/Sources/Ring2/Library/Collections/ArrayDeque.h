...
/// @file Ring2/Library/Collections/ArrayDeque.h
/// @copyright Copyright (c) 2021-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING2_LIBRARY_COLLECTIONS_ARRAYDEQUE_H_INCLUDED)
#define RING2_LIBRARY_COLLECTIONS_ARRAYDEQUE_H_INCLUDED


#if !defined(RING2_LIBRARY_COLLECTIONS_PRIVATE) || 1 != RING2_LIBRARY_COLLECTIONS_PRIVATE
#error("Do not include `Ring2/Library/Collections/ArrayDeque.h` directly. Include `Ring2/Library/Collections/_Include.h` instead.")
#endif
#include "Ring2/_Include.h"


/// @implements Ring2.Collections.Deque
...
/// SIZE' = SIZE + 1.
MACHINE_DECLARE_CLASSTYPE(Ring2_Collections_ArrayDeque)
...
#endif // RING2_LIBRARY_COLLECTIONS_ARRAYDEQUE_H_INCLUDED
