...
/// @file Ring2/Library/Collections/List.h
/// @copyright Copyright (c) 2020-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING2_LIBRARY_COLLECTIONS_LIST_H_INCLUDED)
#define RING2_LIBRARY_COLLECTIONS_LIST_H_INCLUDED


#if !defined(RING2_LIBRARY_COLLECTIONS_PRIVATE) || 1 != RING2_LIBRARY_COLLECTIONS_PRIVATE
#error("Do not include `Ring2/Library/Collections/List.h` directly. Include `Ring2/Library/Collections/_Include.h` instead.")
#endif
#include "Ring2/_Include.h"


/// @brief If defined and evaluateing to @a 1,
/// then the Ring2.Collections.List.slice is provided.
#define Ring2_Collections_List_withReverse (0)

/// @brief If defined and evaluating to @a 1,
/// then Ring2.Collections.List.slice is provided.
#define Ring2_Collections_List_withSlice (0)

/// @extends Ring2.Collections.Collection
MACHINE_DECLARE_INTERFACETYPE(Ring2_Collections_List)

struct Ring2_Collections_List_Dispatch {
  Machine_InterfaceDispatch parent;

  Ring2_Value (*getAt)(Ring2_Collections_List const* self, int64_t index);
  void (*insertAt)(Ring2_Collections_List* self, int64_t index, Ring2_Value value);
  void (*prepend)(Ring2_Collections_List* self, Ring2_Value value);
  void (*append)(Ring2_Collections_List* self, Ring2_Value value);
  void (*removeAt)(Ring2_Collections_List* self, int64_t index);
  void (*removeAtFast)(Ring2_Collections_List* self, int64_t index);
#if defined(Ring2_Collections_List_withReverse) && Ring2_Collections_List_withReverse == 1
  void (*reverse)(Ring2_Collections_List* self);
#endif
#if defined(Ring2_Collections_List_withSlice) && Ring2_Collections_List_withSlice == 1
  Ring2_Collections_List* (*slice)(Ring2_Collections_List* self, int64_t start, int64_t length);
#endif
};
...
#endif // RING2_LIBRARY_COLLECTIONS_LIST_H_INCLUDED
