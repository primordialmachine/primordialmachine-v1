...
/// @file Ring2/Library/Collections/Map.h
/// @copyright Copyright (c) 2020-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING2_LIBRARY_COLLECTIONS_MAP_H_INCLUDED)
#define RING2_LIBRARY_COLLECTIONS_MAP_H_INCLUDED


#if !defined(RING2_LIBRARY_COLLECTIONS_PRIVATE) || 1 != RING2_LIBRARY_COLLECTIONS_PRIVATE
#error("Do not include `Ring2/Library/Collections/Map.h` directly, include `Ring2/Library/Collections/_Include.h` instead.")
#endif
...
MACHINE_DECLARE_INTERFACETYPE(Ring2_Collections_Map)

struct Ring2_Collections_Map_Dispatch {
  Machine_InterfaceDispatch parent;

  Ring2_Value (*get)(Ring2_Collections_Map const* self, Ring2_Value key);
  void (*remove)(Ring2_Collections_Map* self, Ring2_Value key);
  void (*set)(Ring2_Collections_Map* self, Ring2_Value key, Ring2_Value value);
  Ring2_Collections_List* (*toList)(Ring2_Collections_Map const* self);
};
...
#endif // RING2_LIBRARY_COLLECTIONS_MAP_H_INCLUDED
