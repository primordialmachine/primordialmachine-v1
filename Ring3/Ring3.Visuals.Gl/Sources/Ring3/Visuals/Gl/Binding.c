...
{
  Ring3_Binding_Node* node = Ring1_cast(Ring3_Binding*,self)->nodes;
  while (node) {
...
{
  Machine_Gl_ShaderProgram* program = Ring1_cast(Machine_Gl_ShaderProgram*,Ring1_cast(Ring3_Binding*,self)->program);
  ...
  )
{
  ...
  case Ring3_GpuProgramLocationType_Vector2Constant: {
    ...
    if (!Machine_Type_isSubTypeOf(Ring1_cast(Machine_Type*,Machine_getClassType(objectValue)),
                                  Ring3_Math_Vector2f32_getType())) {
      return;
    }
    Ring3_Math_Vector2f32* vectorValue = Ring1_cast(Ring3_Math_Vector2f32*,objectValue);
    GLfloat const temporary[] = { Ring3_Math_Vector2f32_getX(vectorValue),
  ...
  case Ring3_GpuProgramLocationType_Vector3Constant: {
    ...
    Ring3_Math_Vector3f32* vectorValue = Ring1_cast(Ring3_Math_Vector3f32*,objectValue);
    GLfloat const temporary[] = { Ring3_Math_Vector3f32_getX(vectorValue),
  ...
  case Ring3_GpuProgramLocationType_Vector4Constant: {
    ...
    Machine_Object* objectValue = Ring2_Value_getObject(value);
    if (!Machine_Type_isSubTypeOf(Ring1_cast(Machine_Type*,Machine_getClassType(objectValue)),
                                  Ring3_Math_Vector4f32_getType())) {
      return;
    }
    Ring3_Math_Vector4f32* vectorValue = Ring1_cast(Ring3_Math_Vector4f32*,objectValue);
    GLfloat const temporary[] = { Ring3_Math_Vector4f32_getX(vectorValue),
  ...
  case Ring3_GpuProgramLocationType_Matrix4x4Constant: {
    ...
    Machine_Object* objectValue = Ring2_Value_getObject(value);
    if (!Machine_Type_isSubTypeOf(Ring1_cast(Machine_Type*,Machine_getClassType(objectValue)),
                                  Ring3_Math_Matrix4x4f32_getType())) {
      return;
    }
    Ring3_Math_Matrix4x4f32* matrixValue = Ring1_cast(Ring3_Math_Matrix4x4f32*,objectValue);
  ...
  )
{
  ...
  while (node) {
    if (Ring2_String_isEqualTo(Ring2_Context_get(), node->targetName, targetName)) {
      ...
      Ring1_cast(Ring3_Binding*,self)->dirty = true;
      return true;
    }
    node = node->next;
  }
  ...
  node->next = Ring1_cast(Ring3_Binding*,self)->nodes; Ring1_cast(Ring3_Binding*,self)->nodes = node;
  return false;
}
  ...
  )
{
  ...
  Ring2_Value_setObject(&temporary2, Ring1_cast(Machine_Object*,value));
  ...
  )
{
  Ring2_Value temporary2;
  Ring2_Value_setObject(&temporary2, Ring1_cast(Machine_Object*,value));
  Ring3_Binding_addUpdateConstant(Ring1_cast(Ring3_Binding*,self), targetName, Ring3_GpuProgramLocationType_Vector2Constant, &temporary2);
  Ring1_cast(Ring3_Binding*,self)->dirty = true;
}
  ...
  )
{
  Ring2_Value temporary2;
  Ring2_Value_setObject(&temporary2, Ring1_cast(Machine_Object*,value));
  Ring3_Binding_addUpdateConstant(Ring1_cast(Ring3_Binding*,self), targetName, Ring3_GpuProgramLocationType_Vector3Constant, &temporary2);
  Ring1_cast(Ring3_Binding*,self)->dirty = true;
}
  ...
  )
{
  Ring2_Value temporary2;
  Ring2_Value_setObject(&temporary2, Ring1_cast(Machine_Object*,value));
  Ring3_Binding_addUpdateConstant(Ring1_cast(Ring3_Binding*,self), targetName, Ring3_GpuProgramLocationType_Vector4Constant, &temporary2);
  Ring1_cast(Ring3_Binding*,self)->dirty = true;
}
...
{
  Ring2_Value temporary2;
  Ring2_Value_setInteger(&temporary2, Ring1_cast(Ring2_Integer,value));
  Ring3_Binding_addUpdateConstant(Ring1_cast(Ring3_Binding*,self), targetName, Ring3_GpuProgramLocationType_SamplerConstant, &temporary2);
  Ring1_cast(Ring3_Binding*,self)->dirty = true;
}
  ...
  )
{
  ...
  if (Ring1_cast(Ring3_Binding*,self)->dirty) {
    if (!self->id) {
    ...
    // Bind constants.
    for (Ring3_Binding_Node* node = Ring1_cast(Ring3_Binding*,self)->nodes; NULL != node; node = node->next) {
      if (!node->isVariable) {
...
{
  Ring3_Binding_construct(Ring1_cast(Ring3_Binding*,self), numberOfArguments, arguments);
  self->id = 0;
