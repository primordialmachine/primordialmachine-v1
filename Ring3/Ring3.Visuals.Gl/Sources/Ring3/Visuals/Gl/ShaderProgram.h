/// @file Ring3/Visuals/Gl/ShaderProgram.h
/// @copyright Copyright (c) 2021-2023 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING3_VISUALS_GL_SHADERPROGRAM_H_INCLUDED)
#define RING3_VISUALS_GL_SHADERPROGRAM_H_INCLUDED


#if !defined(RING3_VISUALS_GL_PRIVATE)
#error("Do not include `Ring3/Visuals/Gl/ShaderProgram.h` directly. Include `Ring3/Visuals/Gl/_Include.h` instead.")
#endif
...
#endif // RING3_VISUALS_GL_SHADERPROGRAM_H_INCLUDED
