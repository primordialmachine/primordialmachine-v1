// @file Ring3/Gdl/Literals/IntegerLiteral.c
...
{
  Machine_Type* ty = Ring3_Gdl_IntegerLiteral_getType();
  static size_t const NUMBER_OF_ARGUMENTS = 1;
  Ring2_Value arguments[1];
  Ring2_Value_setString(&arguments[0], literalString);
  Ring3_Gdl_IntegerLiteral* self = Ring1_cast(Ring3_Gdl_IntegerLiteral*,Machine_allocateClassObject(ty, NUMBER_OF_ARGUMENTS, arguments));
  return self;
}
