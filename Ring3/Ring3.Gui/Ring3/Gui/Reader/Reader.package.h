/// @file Ring3/Gui/Reader/Reader.package.h
...
#error("Do not include `Ring3/Gui/Reader/Reader.package.h` directly, include `Ring/Gui/_Include.h` instead.")
#endif
...
// USED
Ring1_Inline() Ring1_NoDiscardReturn() Ring2_String*
Machine_Gui_Reader_getString
  (
    Ring2_Collections_Map const* map,
    Ring2_String * key
  )
...
// USED
Ring1_Inline() Ring1_NoDiscardReturn() Machine_Object*
Machine_Gui_Reader_getObject
  (
    Ring2_Collections_Map const* map,
    Ring2_String *key
  )
...
Ring1_Inline() Ring1_NoDiscardReturn() Ring2_Value
getMapOrVoid
  (
    Machine_Gui_Context* self,
    Ring2_Collections_Map const* map,
...
Ring1_Inline() Ring1_NoDiscardReturn() Ring2_Collections_Map*
Machine_Gui_Reader_getMap
  (
    Machine_Gui_Context* self,
    Ring2_Collections_Map const* map,
    Ring2_String *key
...
Ring1_Inline() Ring1_NoDiscardReturn() Ring2_Collections_List*
Machine_Gui_Reader_getList
  (
    Machine_Gui_Context* self,
    Ring2_Collections_Map const* map,
    Ring2_String *key
