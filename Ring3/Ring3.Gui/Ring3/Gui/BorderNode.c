...
struct Machine_Gui_BorderNode {
  ...
  bool childDirty;
  Ring3_Rectangle2* borderRectangle;
};
  ...
  )
{
  ...
  self->borderRectangle = Ring3_Rectangle2_create();
  self->childDirty = true;
  ...
  )
{
  ...
  ((Machine_Gui_Widget_Class*)self)->getCanvasRectangle
    = (Ring3_Math_Rectangle2* (*)(Machine_Gui_Widget const*))
    & Machine_Gui_BorderNode_getCanvasRectangle;
}
...
{
  Ring3_Math_Rectangle2* rectangle = Ring3_Math_Rectangle2_clone(Machine_Gui_Widget_getRectangle((Machine_Gui_Widget*)self));
  ...
  )
{
  ...
  Ring3_Context2* context2 = ((Machine_Gui_Widget*)self)->context->context2;
  if (self->childDirty) {
  ...
  Machine_Gui_Widget_render(self->child, renderContext);

  {
    Ring3_Math_Vector4f32 const* c = Machine_Gui_BorderModel_getColor(self->borderModel);
    Ring3_Rectangle2_setColor(self->borderRectangle, c);
  }
  ...
  if (lw > 0.f || tw > 0.f || rw > 0.f || bw > 0.f) {
    ...
    {                               // left/top
      ...
      Ring3_Rectangle2_setRectangle(self->borderRectangle, r);
      Ring3_Shape2_render((Ring3_Shape2*)self->borderRectangle, context2);
    }
    { // right/top
      Ring3_Math_Rectangle2* r = Ring3_Math_Rectangle2_create();
  ...
  )
{
  Ring3_Math_Vector2f32* preferredSize = self->child
                                       ? Ring3_Math_Vector2f32_clone(Machine_Gui_Widget_getPreferredSize(self->child))
