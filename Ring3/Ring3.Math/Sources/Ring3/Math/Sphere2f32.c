/// @file Ring3/Math/Sphere2f32.c
/// @copyright Copyright (c) 2021-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#define RING3_MATH_PRIVATE (1)
#include "Ring3/Math/Sphere2f32.h"
#undef RING3_MATH_PRIVATE

MACHINE_DEFINE_CLASSTYPE(Ring3_Math_Sphere2f32,
                         Machine_Object,
                         NULL,
  ...
  )
{
  ...
  self->center = Ring3_Math_Vector2f32_clone((Ring3_Math_Vector2f32*)Ring2_CallArguments_getObjectArgument(numberOfArguments, arguments, 0, Ring3_Math_Vector2f32_getType()));
  self->radius = Ring2_CallArguments_getReal32Argument(numberOfArguments, arguments, 1);
  if (self->radius < 0) {
    Ring1_Status_set(Ring1_Status_InvalidArgument);
    Ring2_jump();
  }
  Machine_setClassType(Ring1_cast(Machine_Object *, self), Ring3_Math_Sphere2f32_getType());
}
...
{ return Ring3_Math_Vector2f32_clone(self->center); }
...
{
  return Ring3_Math_Sphere2f32_create(self->center, self->radius);
}
...
{
  Ring3_Math_Sphere2f32* clone = Ring3_Math_Sphere2f32_clone(self);
  Ring3_Math_Sphere2f32_translateInSitu(clone, translation);
  return clone;
}
...
{ Ring3_Math_Vector2f32_add(self->center, translation, self->center); }
...
{
  Ring3_Math_Vector2f32_multiplyScalarInSitu(self->center, s);
  self->radius *= fabs(s);
}
  ...
  )
{
  ...
  return Ring3_Math_Vector2f32_isEqualToWithTolerance(self->center, other->center, absolute, relative)
      && equal;
}
