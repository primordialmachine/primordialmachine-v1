...
{
  Machine_Type* ty = Ring3_Math_ColorRgbaU8_getType();
  ...
  Ring3_Math_ColorRgbaU8* self = Ring1_cast(Ring3_Math_ColorRgbaU8*,Machine_allocateClassObject(ty, NUMBER_OF_ARGUMENTS, arguments));
  return self;
}
