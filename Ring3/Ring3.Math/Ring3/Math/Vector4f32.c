...
static void
Ring3_Math_Vector4f32_construct
  (
  ...
  )
{
  ...
  self->e[3] = 0.f;
#endif
  Machine_setClassType(Ring1_cast(Machine_Object *, self), Ring3_Math_Vector4f32_getType());
}

MACHINE_DEFINE_CLASSTYPE(Ring3_Math_Vector4f32,
                         Machine_Object,
                         NULL,
                         &Ring3_Math_Vector4f32_construct,
                         NULL,
...
{
  Machine_ClassType* ty = Ring3_Math_Vector4f32_getType();
  static const size_t NUMBER_OF_ARGUMENTS = 0;
  static const Ring2_Value ARGUMENTS[] = { { Ring2_Value_Tag_Void, Ring2_Void_Void } };
  Ring3_Math_Vector4f32* self = Ring1_cast(Ring3_Math_Vector4f32*, Machine_allocateClassObject(ty, NUMBER_OF_ARGUMENTS, ARGUMENTS));
  return self;
}
...
{
  Ring3_Math_Vector4f32* other = Ring3_Math_Vector4f32_create();
  Ring3_Math_Vector4f32_copy(other, self);
  return other;
}
...
{
  add_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  Ring3_Math_Vector4f32* target = Ring3_Math_Vector4f32_create();
  add_vv_f32(self->e, other->e, target->e, 4);
  return target;
}
...
{
  sub_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  mul_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  div_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  Ring2_Real32 target;
  dot_vv_f32(self->e, other->e, &target, 4);
  return target;
}
...
{
  max_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  min_vv_f32(self->e, other->e, target->e, 4);
}
...
{
  Ring3_Math_Vector4f32* target = Ring3_Math_Vector4f32_create();
  mul_vs_f32(self->e, other, target->e, 4);
  return target;
}
...
{
  mul_vs_f32(self->e, other, self->e, 4);
}
...
{
  Ring3_Math_Vector4f32* target = Ring3_Math_Vector4f32_create();
  div_vs_f32(self->e, other, target->e, 4);
  return target;
}
...
{
  div_vs_f32(self->e, other, self->e, 4);
}
...
{
  Ring2_Real32 t;
  squaredLength_vs_f32(self->e, &t, 4);
  return t;
}
...
{
  Ring2_Real32 l = Ring3_Math_Vector4f32_length(a);
  return Ring3_Math_Vector4f32_divideScalar(a, l);
}
...
{
  Ring2_Real32 l = Ring3_Math_Vector4f32_length(a);
  Ring3_Math_Vector4f32_divideScalarInSitu(a, l);
}
  ...
  )
{
  ...
  minMax_vv_f32(a->e, b->e, min->e, max->e, 4);
}
  ...
  )
{
  ...
  return Ring3_Math_Vector4f32_create(temporary[0], temporary[1], temporary[2]);
}
  ...
  )
{
  ...
  Ring3_Math_Vector4f32_set(a, temporary[0], temporary[1], temporary[2]);
}
