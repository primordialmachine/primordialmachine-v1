/// @file Ring3/Math/Vector3f32.h
/// @copyright Copyright (c) 2021-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING3_MATH_VECTOR3F32_H_INCLUDED)
#define RING3_MATH_VECTOR3F32_H_INCLUDED

#if !defined(RING3_MATH_PRIVATE)
#error("Do not include `Ring3/Math/Vector3f32.h` directly, include `Ring3/Math/_Include.h` instead.")
#endif
...
/// @code
/// class Ring3.Math.Vector3f32 { ... }
/// @endcode
MACHINE_DECLARE_CLASSTYPE(Ring3_Math_Vector3f32)

struct Ring3_Math_Vector3f32_Class {
  Machine_Object_Class parent;
};

struct Ring3_Math_Vector3f32 {
...
#endif // RING3_MATH_VECTOR3F32_H_INCLUDED
