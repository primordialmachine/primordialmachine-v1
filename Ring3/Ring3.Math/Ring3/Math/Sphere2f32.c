  ...
  )
{
  ...
  self->center = Ring3_Math_Vector2f32_clone((Ring3_Math_Vector2f32*)Machine_Extensions_getObjectArgument(numberOfArguments, arguments, 0, Ring3_Math_Vector2f32_getType()));
