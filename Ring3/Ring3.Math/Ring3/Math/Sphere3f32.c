...
{
  Machine_ClassType* ty = Ring3_Math_Sphere3f32_getType();
  ...
  Ring3_Math_Sphere3f32* self = Ring1_cast(Ring3_Math_Sphere3f32*, Machine_allocateClassObject(ty, NUMBER_OF_ARGUMENTS, arguments));
  return self;
}
