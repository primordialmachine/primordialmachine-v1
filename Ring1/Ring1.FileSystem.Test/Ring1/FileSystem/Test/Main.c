...
#include <stdlib.h>
#include "Ring1/FileSystem/Test/createDirectory.h"
  ...
  )
{
  ...
  if (/*Ring1_FileSystem_Test_registerCreateDirectoryTests(ctx) ||*/
      Ring1_FileSystem_Test_registerGetCurrentDirectoryTests(ctx) ||
      Ring1_FileSystem_Test_registerGetTemporaryDirectoryTests(ctx) ||
      Ring1_FileSystem_Test_registerCreatePathTests(ctx) ||
      Ring1_FileSystem_Test_registerConcatenatePathTests(ctx)) {
