...
/// @file Ring1/Ap/Test/Nat/Compare.h
/// @copyright Copyright (c) 2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING1_AP_TEST_NAT_COMPARE_H_INCLUDED)
#define RING1_AP_TEST_NAT_COMPARE_H_INCLUDED
...
#endif // RING1_AP_TEST_NAT_COMPARE_H_INCLUDED
