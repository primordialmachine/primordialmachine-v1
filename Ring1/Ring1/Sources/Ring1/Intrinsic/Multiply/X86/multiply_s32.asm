...
; char __fastcall Ring1_Intrinsic_Multiply_X86_multiply_s32(int32_t x, int32_t y, int32_t *z)
; See README.md for more information.
@Ring1_Intrinsic_Multiply_X86_multiply_s32@12 PROC
  ...
  SETC al
  RET
@Ring1_Intrinsic_Multiply_X86_multiply_s32@12 ENDP
