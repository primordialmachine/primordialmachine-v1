...
; char __fastcall Ring1_Intrinsic_Add_X86_add_u64(uint64_t x, uint64_t y, uint64_t *z)
; See README.md for more information.
@Ring1_Intrinsic_Add_X86_add_u64@20 PROC
  ...
  RET               ; RETURN
@Ring1_Intrinsic_Add_X86_add_u64@20 ENDP
