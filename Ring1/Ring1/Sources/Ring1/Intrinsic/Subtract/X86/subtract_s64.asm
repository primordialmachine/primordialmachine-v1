...
; char __fastcall Ring1_Intrinsic_Subtract_X86_subtract_u64(int64_t x, int64_t y, int64_t *z)
; See README.md for more information.
@Ring1_Intrinsic_Subtract_X86_subtract_s64@20 PROC
  ...
  RET               ; RETURN
@Ring1_Intrinsic_Subtract_X86_subtract_s64@20 ENDP
