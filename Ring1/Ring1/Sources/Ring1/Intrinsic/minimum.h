...
/// @file Ring1/Intrinsic/minimum.h
/// @author Michael Heilmann <michaelheilmann@primordialmachine.com>
/// @copyright Copyright (c) 2019-2022 Michael Heilmann. All rights reserved.

#if !defined(RING1_INTRINSIC_MINIMUM_H_INCLUDED)
#define RING1_INTRINSIC_MINIMUM_H_INCLUDED

#include <inttypes.h>
#include "Ring1/Result.h"

#define IMPLEMENTATION(SUFFIX, TYPE) \
  Ring1_Result Ring1_Intrinsic_minimum_##SUFFIX(TYPE * result, TYPE const x, TYPE const y);
...
#endif // RING1_INTRINSIC_MINIMUM_H_INCLUDED
