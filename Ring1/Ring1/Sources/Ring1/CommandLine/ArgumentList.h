...
/// @file Ring1/CommandLine/ArgumentList.h
/// @copyright Copyright (c) 2019-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING1_COMMANDLINE_ARGUMENTLIST_H_INCLUDED)
#define RING1_COMMANDLINE_ARGUMENTLIST_H_INCLUDED
...
typedef struct Ring1_CommandLine_ArgumentList Ring1_CommandLine_ArgumentList;

/// @brief
/// Create a <code>Ring1_CommandLine_ArgumentList</code> object.
/// 
/// @param [out] result
/// A pointer to a <code>Ring1_CommandLine_ArgumentList *</code> variable.
/// 
/// @return
...
#endif // RING1_COMMANDLINE_ARGUMENTLIST_H_INCLUDED
