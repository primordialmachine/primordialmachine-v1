...
/// @file Ring1/FileSystem/Windows/createDirectory.h
/// @copyright Copyright (c) 2023 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING1_FILESYSTEM_WINDOWS_CREATEDIRECTORY_H_INCLUDED)
#define RING1_FILESYSTEM_WINDOWS_CREATEDIRECTORY_H_INCLUDED
...
Ring1_FileSystem_Windows_createDirectory
  (
...
#endif // RING1_FILESYSTEM_WINDOWS_CREATEDIRECTORY_H_INCLUDED
