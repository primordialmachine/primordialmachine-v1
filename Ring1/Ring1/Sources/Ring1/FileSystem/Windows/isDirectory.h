...
/// @file Ring1/FileSystem/Windows/isDirectory.h
/// @copyright Copyright (c) 2023 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING1_FILESYSTEM_WINDOWS_ISDIRECTORY_H_INCLUDED)
#define RING1_FILESYSTEM_WINDOWS_ISDIRECTORY_H_INCLUDED
...
Ring1_FileSystem_Windows_isDirectory
  (
    bool* result,
    char const* path
  );
...
#endif // RING1_FILESYSTEM_WINDOWS_ISDIRECTORY_H_INCLUDED
