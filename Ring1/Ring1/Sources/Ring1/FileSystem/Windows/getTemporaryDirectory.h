...
/// @file Ring1/FileSystem/Windows/getTemporaryDirectory.h
/// @copyright Copyright (c) 2019-2022 Michael Heilmann. All rights reserved.
/// @author Michael Heilmann (michaelheilmann@primordialmachine.com)

#if !defined(RING1_FILESYSTEM_WINDOWS_GETTEMPORARYDIRECTORY_H_INCLUDED)
#define RING1_FILESYSTEM_WINDOWS_GETTEMPORARYDIRECTORY_H_INCLUDED
...
#endif // RING1_FILESYSTEM_WINDOWS_GETTEMPORARYDIRECTORY_H_INCLUDED
