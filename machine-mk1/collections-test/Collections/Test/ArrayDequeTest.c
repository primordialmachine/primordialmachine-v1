  ...
  )
{
  ...
  RING2_TEST_ASSERT(0 == Machine_Collection_getSize((Machine_Collection*)deque));
  ...
  )
{
  ...
  RING2_TEST_ASSERT(N == Machine_Collection_getSize((Machine_Collection*)deque));
  for (size_t i = 0, n = N; i < n; ++i) {
  ...
  )
{
  ...
  RING2_TEST_ASSERT(8 == Machine_Collection_getSize((Machine_Collection*)deque));
  // Pop 5 items.
  ...
  RING2_TEST_ASSERT(3 == Machine_Collection_getSize((Machine_Collection*)deque));
  // Push 5 items.
  for (size_t i = 0, n = 5; i < n; ++i) {
    Ring2_Value_setInteger(&value, k++);
    Machine_Deque_pushFront(deque, value);
