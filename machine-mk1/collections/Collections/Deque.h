...
struct Machine_Deque_Dispatch {
  ...
  void (*pushFront)(Machine_Deque* self, Machine_Value value);
  Machine_Value (*popFront)(Machine_Deque* self);
  void (*pushBack)(Machine_Deque* self, Machine_Value value);
  Machine_Value (*popBack)(Machine_Deque* self);
};
