...
Machine_StatusValue Machine_Collections_getBestCapacity(size_t oldCapacity, size_t requiredAdditionalCapacity, size_t maximalCapacity, size_t* newCapacity) {
  int status = Machine_Eal_getBestCapacity(oldCapacity, requiredAdditionalCapacity, maximalCapacity, newCapacity);
  switch (status) {
