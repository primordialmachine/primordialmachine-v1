...
static Machine_Math_Vector2 const* Machine_Gui_TextNode_getPreferredSize(Machine_Gui_TextNode const* self);
...
static void Machine_Gui_TextNode_constructClass(Machine_Gui_TextNode_Class* self) {
  ((Machine_Gui_Widget_Class*)self)->render = (void (*)(Machine_Gui_Widget*, Machine_Context2*)) & Machine_Gui_TextNode_render;
  ((Machine_Gui_Widget_Class*)self)->getPreferredSize = (Machine_Math_Vector2 const* (*)(Machine_Gui_Widget const*)) & Machine_Gui_TextNode_getPreferredSize;
}
...
MACHINE_DEFINE_CLASSTYPE(Machine_Gui_TextNode, Machine_Gui_Widget, &Machine_Gui_TextNode_visit, &Machine_Gui_TextNode_construct, NULL, &Machine_Gui_TextNode_constructClass)
...
Machine_Gui_TextNode* Machine_Gui_TextNode_create(Machine_Gui_Context* context) {
  ...
  Machine_Gui_TextNode* self = (Machine_Gui_TextNode*)Machine_allocateClassObject(ty, NUMBER_OF_ARGUMENTS, arguments);
  return self;
}
...
static void Machine_Gui_TextNode_render2(Machine_Gui_TextNode* self, Machine_Real width, Machine_Real height) {
...
void Machine_Gui_TextNode_render(Machine_Gui_TextNode* self, Machine_Context2* ctx2) {
  Machine_Gui_TextNode_render2(self, Machine_Context2_getTargetWidth(ctx2), Machine_Context2_getTargetHeight(ctx2));
}
