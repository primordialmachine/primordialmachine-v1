...
static void Scene3_startup(Scene3* scene) {
  ...
  scene->shaderProgram = Machine_VideoContext_generateDefaultShader(Machine_Video_getContext(), false, true, true, true);
...
static void Scene3_update(Scene3* self, float width, float height) {
  ...
  Machine_VideoContext_bindTexture(Machine_Video_getContext(), 0, self->texture);
