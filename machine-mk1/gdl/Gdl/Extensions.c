...
static Ring2_Value convert(Machine_Gdl_Node* self, Machine_Gdl_Context* context) {
  ...
  case Machine_Gdl_NodeKind_List: {
    Ring2_List* temporary = Machine_Gdl_Node_toList(self, context);
    Ring2_Value value;
    Ring2_Value_setObject(&value, (Machine_Object *)temporary);
    return value;
  }
  case Machine_Gdl_NodeKind_Map: {
    Ring2_Map* temporary = Machine_Gdl_Node_toMap(self, context);
    Ring2_Value value;
    Ring2_Value_setObject(&value, (Machine_Object *)temporary);
    return value;
  }
...
Ring2_List* Machine_Gdl_Node_toList(Machine_Gdl_Node const* self, Machine_Gdl_Context* context) {
  ...
  Ring2_List* targets = (Ring2_List *)Ring2_ArrayList_create();
  for (size_t i = 0, n = Ring2_Collection_getSize((Ring2_Collection*)self->children); i < n; ++i) {
    Ring2_Value v = Ring2_List_getAt(self->children, i);
    Machine_Gdl_Node* source = (Machine_Gdl_Node*)Ring2_Value_getObject(&v);
    v = convert(source, context);
    Ring2_List_append(targets, v);
  }
  return targets;
}
...
Ring2_Map* Machine_Gdl_Node_toMap(Machine_Gdl_Node const* self, Machine_Gdl_Context* context) {
  ...
  Ring2_Map* targets = (Ring2_Map *)Ring2_HashMap_create();
  for (int64_t i = 0, n = Ring2_Collection_getSize(Ring1_cast(Ring2_Collection *, self->children)); i < n; ++i) {
    Ring2_Value v = Ring2_List_getAt(self->children, i);
    ...
    Ring2_Map_set(targets, Machine_Pair_get(targetPair, 0), Machine_Pair_get(targetPair, 1));
  }
  return targets;
}
...
Machine_Pair* Machine_Gdl_Node_toPair(Machine_Gdl_Node const* self, Machine_Gdl_Context* context) {
  ...
  Ring2_Value x = Ring2_List_getAt(self->children, 0),
              y = Ring2_List_getAt(self->children, 1);
