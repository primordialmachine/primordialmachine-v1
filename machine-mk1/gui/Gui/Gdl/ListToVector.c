...
Ring3_Math_Vector3* Machine_Gui_Gdl_listToVector3(Ring2_Collections_List const* list) {
  ...
  Ring3_Math_Vector3* vector = Ring3_Math_Vector3_create();
  Ring3_Math_Vector3_set(vector,
...
Ring3_Math_Vector4* Machine_Gui_Gdl_listToVector4(Ring2_Collections_List const* list) {
  ...
  Ring3_Math_Vector4* vector = Ring3_Math_Vector4_create();
  Ring3_Math_Vector4_set(vector, Machine_Gui_Gdl_valueToReal(&values[0]), Machine_Gui_Gdl_valueToReal(&values[1]),
