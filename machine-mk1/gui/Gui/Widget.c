...
static Ring3_Math_Rectangle2 const* Machine_Gui_Widget_getRectangleImpl(
    Machine_Gui_Widget const* self) {
  return self->rectangle;
}

static Ring3_Math_Rectangle2 const* Machine_Gui_Widget_getCanvasRectangleImpl(
    Machine_Gui_Widget const* self) {
...
static Ring3_Math_Rectangle2 const* Machine_Gui_Widget_getAbsoluteRectangleImpl(
    Machine_Gui_Widget const* self) {
  Ring3_Math_Rectangle2 const* rectangle = Machine_Gui_Widget_getRectangle(self);
  if (self->parent) {
    Ring3_Math_Rectangle2* rectangle_ = Ring3_Math_Rectangle2_clone(rectangle);
    Ring3_Math_Rectangle2_translate(rectangle_,
                                      Machine_Gui_Widget_getAbsolutePosition(self->parent));
    return rectangle_;
  } else {
    return rectangle;
...
static Ring3_Math_Rectangle2 const* Machine_Gui_Widget_getAbsoluteCanvasRectangleImpl(
    Machine_Gui_Widget const* self) {
  Ring3_Math_Rectangle2 const* rectangle = Machine_Gui_Widget_getCanvasRectangle(self);
  if (self->parent) {
    Ring3_Math_Rectangle2* rectangle_ = Ring3_Math_Rectangle2_clone(rectangle);
    Ring3_Math_Rectangle2_translate(
        rectangle_, Ring3_Math_Rectangle2_getPosition(
...
static void Machine_Gui_Widget_constructClass(Machine_Gui_Widget_Class* self) {
  ...
  self->getAbsoluteCanvasRectangle = (Ring3_Math_Rectangle2 const* (*)(Machine_Gui_Widget const*))
