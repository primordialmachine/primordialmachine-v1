...
static Ring3_Math_Vector2f32 const* Machine_Gui_GroupNode_getPreferredSize(
...
static void Machine_Gui_GroupNode_render(Machine_Gui_GroupNode* self, Machine_Context2* ctx2) {
  ...
  Ring3_Math_Vector2f32 const* size = Machine_Gui_Widget_getSize((Machine_Gui_Widget*)self);
  Machine_Context2* tmp = Machine_Context2_create(ctx2->videoContext);
  Machine_Context2_setTargetSize(tmp, Ring3_Math_Vector2f32_getX(size),
...
void Machine_Gui_GroupNode_relayout(Machine_Gui_GroupNode* self, Ring2_Real32 canvasWidth,
  ...
  // Layout the children.
  Ring3_Math_Vector2f32 const* size = Machine_Gui_Widget_getSize((Machine_Gui_Widget*)self);
  Machine_Gui_WidgetList_layout(self->children, Ring3_Math_Vector2f32_getX(size),
                                                Ring3_Math_Vector2f32_getY(size),
                                                canvasWidth,
                                                canvasHeight,
                                                self->layoutModel);
