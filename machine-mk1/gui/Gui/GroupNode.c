...
static Machine_Math_Vector2 const* Machine_Gui_GroupNode_getPreferredSize(Machine_Gui_GroupNode const* self) {
...
static void Machine_Gui_GroupNode_constructClass(Machine_Gui_GroupNode_Class* self) {
  ((Machine_Gui_Widget_Class*)self)->render = (void (*)(Machine_Gui_Widget*, Machine_Context2*)) & Machine_Gui_GroupNode_render;
  ((Machine_Gui_Widget_Class*)self)->getPreferredSize = (Machine_Math_Vector2 const* (*)(Machine_Gui_Widget const*)) & Machine_Gui_GroupNode_getPreferredSize;
}

void Machine_Gui_GroupNode_construct(Machine_Gui_GroupNode* self, size_t numberOfArguments, Machine_Value const* arguments) {
  ...
  Machine_setClassType((Machine_Object*)self, Machine_Gui_GroupNode_getClassType());
}

MACHINE_DEFINE_CLASSTYPE(Machine_Gui_GroupNode, Machine_Gui_Widget, &Machine_Gui_GroupNode_visit, &Machine_Gui_GroupNode_construct, NULL, &Machine_Gui_GroupNode_constructClass)

Machine_Gui_GroupNode* Machine_Gui_GroupNode_create(Machine_Gui_Context* context) {
  Machine_ClassType* ty = Machine_Gui_GroupNode_getClassType();
...
Machine_Gui_LayoutModel const* Machine_Gui_GroupNode_getLayoutModel(Machine_Gui_GroupNode const* self) {
  return self->layoutModel;
}

void Machine_Gui_GroupNode_setLayoutModel(Machine_Gui_GroupNode* self, Machine_Gui_LayoutModel* layoutModel) {
  self->layoutModel = layoutModel;
}

void Machine_Gui_GroupNode_relayout(Machine_Gui_GroupNode* self, Machine_Real canvasWidth, Machine_Real canvasHeight) {
