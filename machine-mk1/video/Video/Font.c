...
Ring2_Boolean Machine_Font_getCodePointInfo(Machine_Font* self, uint32_t codepoint, Ring3_Math_Rectangle2* bounds, Ring3_Math_Vector2f32* advance, Ring3_Texture** texture) {
