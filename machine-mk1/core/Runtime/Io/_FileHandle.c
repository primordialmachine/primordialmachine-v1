...
void _Machine_FileHandle_open(_Machine_FileHandle* self, Machine_String* path,
  ...
  static const PolicyMapping policyMappings[] = {
    ...
    // It is not used.
    { Machine_ExistingFilePolicy_Truncate, Machine_NonExistingFilePolicy_Create, CREATE_ALWAYS, 0 },
    { Machine_ExistingFilePolicy_Retain, Machine_NonExistingFilePolicy_Create, OPEN_ALWAYS, 0 },
    { Machine_ExistingFilePolicy_Truncate, Machine_NonExistingFilePolicy_Fail, TRUNCATE_EXISTING,
      GENERIC_WRITE },
    { Machine_ExistingFilePolicy_Retain, Machine_NonExistingFilePolicy_Fail, OPEN_EXISTING, 0 },
  };
