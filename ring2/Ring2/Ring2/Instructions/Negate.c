...
/// @file Ring2/Instructions/Negate.c
...
void
Mkx_Interpreter_Instructions_negate
  (
    Ring2_Context* context
  )
{
  // Assert the single operand exists.
  ...
  case Ring2_Value_Tag_Boolean: {
    Ring2_Value_setBoolean(x, Ring2_Boolean_negate(context, Ring2_Value_getBoolean(x)));
  } break;
  case Ring2_Value_Tag_Integer: {
    Ring2_Value_setInteger(x, Ring2_Integer_negate(context, Ring2_Value_getInteger(x)));
  } break;
  case Ring2_Value_Tag_Real64: {
    Ring2_Value_setReal64(x, Ring2_Real64_negate(context, Ring2_Value_getReal64(x)));
  } break;
  default: {
