...
$jobs +=
  @(
    ...
    # Ring 1 - ByteBuffer Library.
    #@('./ring1-library/bytebuffer-library.html.template',
    #  './ring1-library/bytebuffer-library.html'),
    ...
    #@('./ring1-library/pointerlist-library.html.template',
    #  './ring1-library/pointerlist-library.html')
  );
