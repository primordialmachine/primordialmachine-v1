...
<h2 id="ring1_intrinsic_add">Ring1_Intrinsic_add</h2>
<p>Compute the sum of two values detecting numeric overflows.</p>

<p><code class="block">
Ring1_Result<br/>
Ring1_Intrinsic_add_<em>suffix</em><br/>
&nbsp;&nbsp;(<br/>
...
<dl class="parameters">
  ...
  <dd>The first value aka augend.</dd>
  <dt><code class="inline">y</code></dt>
  <dd>The second value aka addend.</dd>
...
the value assigned to the variable are the lower n bits of the 2's complements sum of the addend and the augend.</p>
<p>Consequently, these functions can be used to perform safe addition of signed and unsigned integers.</p>
