...
<h2 id="ring1_intrinsic_subtract">Ring1_Intrinsic_subtract</h2>
<p>Compute the difference of two values detecting numeric overflow.</p>

<p><code class="block">
Ring1_Result<br/>
Ring1_Intrinsic_subtract_<em>suffix</em><br/>
&nbsp;&nbsp;(<br/>
...
<dl class="parameters">
  ...
  <dd>The first value aka minuend.</dd>
  <dt><code class="inline">y</code></dt>
  <dd>The second value aka subtrahend.</dd>
...
the value assigned to the variable are the lower n bits of the mathematical sum of the minuend and the subtrahend.
...
the value assigned to the variable are the lower n bits of the 2's complements difference of the minuend and the subtrahend.</p>
<p>Consequently, these functions can be used to perform safe subtraction of signed and unsigned integers.</p>
