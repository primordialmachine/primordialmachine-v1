...
<h2 id="ring1_intrinsic_likely">Ring1_Intrinsic_Likely</h2>
<p>Annotation an integral expression as likely to evaluate to a non-zero integral value.</p>

<p><code class="block">
#define Ring1_Intrinsic_Likely(expression) /*Implementation.*/
</code></p>
