...
<h2 id="ring1_intrinsic_fp_negativezerobits">Ring1_Intrinsic_Fp_NegativeZeroBits</h2>
<code class="block">
#define Ring1_Intrinsic_Fp_NegativeZeroBits_<em>suffix</em> /* Implementation */
</code>
<p>
...
This value represents the negative zero value of the raw bits representation of a single-precision floating point value.
</p>
<p>
For suffix <code class="inline">f64</code>:
Symbolic constant evaluating to an <code class="inline">uint64_t</code> value.
This value represents the negative zero value of the raw bits representation of a double-precision floating point value.
</p>
