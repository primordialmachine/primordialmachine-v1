...
<h2 id="ring1_intrinsic_minium">Ring1_Intrinsic_minimum</h2>
<p>Get the minimum of two values.</p>
<p><code class="block">
Ring1_Result<br/>
...
<p>If this function succeeds, then <code class="inline">*result</code> was assigned the minimum of <code class="inline">x</code> and
