...
<h2 id="ring_memory_copyarrayfast">Ring1_Memory_copyArrayFast</h3>
<p>Copy Bytes from a source memory block to a target memory block.</p>
<p><code class="block">
Ring1_Result<br/>
Ring1_Memory_copyArrayFast<br/>
&nbsp;&nbsp;(<br/>
&nbsp;&nbsp;&nbsp;&nbsp;void *p,<br/>
&nbsp;&nbsp;&nbsp;&nbsp;const void *q,<br/>
...
Use <a href="@(baseurl)api/ring1-library/memory-library/Ring1_Memory_copyArraySlow">Ring1_Memory_copyArraySlow</a> to copy Bytes between overlapping memory blocks.
</p>
