...
<h2 id="ring1_memory_allocate">Ring1_Memory_allocate</h2>
...
<p>
This function allocates a memory block of <code class="inline">n</code> Bytes.
</p>
...
<dl class="parameters">
  ...
  <dd><code class="inline">result</code> is a null pointer</dd>
