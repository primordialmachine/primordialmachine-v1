...
<h2 id="ring1_time_getnowmilliseconds">Ring1_Time_getNowMilliseconds</h2>
<p>Get the time, in milliseconds, since the start of the system.</p>
<p><code class="block">
Ring1_Result<br/>
Ring1_Time_getNowMilliseconds<br/>
&nbsp;&nbsp;(<br/>
...
<p>
This function gets the time, in milliseconds, since the start of the system.
</p>
...
<p>
If this function succeeds, <code class="inline">*result</code> is assigned the time, in milliseconds, since the start of the system.
