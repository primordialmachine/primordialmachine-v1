...
<h2 id="ring1_time_getnowminutes">Ring1_Time_getNowMinutes</h2>
<p>Get the time, in minutes, since the start of the system.</p>
<p><code class="block">
Ring1_Result<br/>
Ring1_Time_getNowMinutes_<em>suffix</em><br/>
&nbsp;&nbsp;(<br/>
...
<p>
If this function succeeds, <code class="inline">*result</code> is assigned the time, in minutes, since the start of the system.
