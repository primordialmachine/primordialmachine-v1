...
<p>Compute the <code class="inline">size_t</code> hash value.</p>
<p><code class="block">
Ring1_Result<br/>
...
<p>
Computes the <code class="inline">size_t</code> hash value of an <code class="inline"><em>type</em></code> value.
</p>
