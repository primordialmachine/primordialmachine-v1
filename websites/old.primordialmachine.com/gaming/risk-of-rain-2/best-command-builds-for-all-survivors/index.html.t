@{ pageTitle = "Primordial Machine :: Gaming :: Risk of Rain 2 :: Best Command Builds for All Survivors" }
...
<main>
<nav>
<a href="@(hostname)">Home</a> &rangle; <a href="@(hostname)">Gaming :: Risk of Rain 2 :: Best Command Builds for All Survivors</a>
</nav>
