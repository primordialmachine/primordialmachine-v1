...
\
  ...
  { \
    Ring2_emitf(Ring2_Context_get(), Ring2_String_fromC(false, "unexpected unevaluated result: received %s, expected %s\n"), unevaluatedReceived, unevaluatedExpected); \
    Ring1_Status_set(Ring1_Status_TestFailed); \
    Ring2_jump(); \
  } \
\
  ...
  { \
    Ring2_emitf(Ring2_Context_get(), Ring2_String_fromC(false, "unexpected evaluated result: received %s, expected %s\n"), evaluatedReceived, evaluatedExpected); \
    Ring1_Status_set(Ring1_Status_TestFailed); \
    Ring2_jump(); \
  } \
\
