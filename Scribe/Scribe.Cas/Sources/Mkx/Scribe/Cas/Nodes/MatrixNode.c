...
#define EMISSION_STYLE EMISSION_STYLE_FUNCTIONAL

#if EMISSION_STYLE == EMISSION_STYLE_FUNCTIONAL

  Mkx_Scribe_Cas_Node* matrix = Ring1_cast(Mkx_Scribe_Cas_Node*, Mkx_Scribe_Cas_OutputNode_create(Ring2_String_fromC(false, "matrix")));
