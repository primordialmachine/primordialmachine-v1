...
/// @file Mkx/Scribe/Cas/Nodes/Index2dNode.h
...
MACHINE_DECLARE_CLASSTYPE(Mkx_Scribe_Cas_Index2dNode)

struct Mkx_Scribe_Cas_Index2dNode_Class {
  Mkx_Scribe_Cas_Node_Class _parent;
};

struct Mkx_Scribe_Cas_Index2dNode {
