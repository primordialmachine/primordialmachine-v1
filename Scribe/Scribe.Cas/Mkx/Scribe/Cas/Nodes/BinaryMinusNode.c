...
static void
Mkx_Scribe_Cas_BinaryMinusNode_visit
  (
    Ring2_Gc* gc,
...
static void
Mkx_Scribe_Cas_BinaryMinusNode_constructClass
  (
    Mkx_Scribe_Cas_BinaryMinusNode_Class *self
  );

MACHINE_DEFINE_CLASSTYPE(Mkx_Scribe_Cas_BinaryMinusNode,
                         Mkx_Scribe_Cas_Node,
                         &Mkx_Scribe_Cas_BinaryMinusNode_visit,
  ...
  )
{
  ...
  if (Mkx_Scribe_Cas_NodeKind_BinaryMinus != Mkx_Scribe_Cas_Node_getKind(node))
  {
    Ring1_Log_error("%s:%d: invalid argument type\n", __FILE__, __LINE__);
    Ring1_Status_set(Ring1_Status_InvalidArgumentType);
    Ring2_jump();
  }
  Mkx_Scribe_Cas_BinaryMinusNode *binaryMinusNode = Ring1_cast(Mkx_Scribe_Cas_BinaryMinusNode * , node);
  if (!binaryMinusNode->leftOperand || !binaryMinusNode->rightOperand)
  {
    Ring1_Log_error("%s:%d: invalid argument\n", __FILE__, __LINE__);
    Ring1_Status_set(Ring1_Status_InvalidArgument);
    Ring2_jump();
...
static Mkx_Scribe_Cas_BinaryMinusNode *
clone
  (
    Mkx_Scribe_Cas_BinaryMinusNode *self
  )
{
  return Mkx_Scribe_Cas_BinaryMinusNode_create(self->leftOperand ? Mkx_Scribe_Cas_Node_clone(self->leftOperand) : NULL,
  ...
  )
{
  ...
  for (int64_t i = 0; i < n; ++i)
  {
    ...
    Mkx_Scribe_Cas_Node* z = Ring1_cast(Mkx_Scribe_Cas_Node*, Mkx_Scribe_Cas_BinaryMinusNode_create(x, y));
  ...
  )
{
  ...
  {
    Ring1_Log_error("%s:%d: operand matrices must be of same dimensionality\n", __FILE__, __LINE__);
    Ring1_Status_set(Ring1_Status_InvalidOperation);
    Ring2_jump();
  }
  ...
  )
{
  ...
  if (OPTIMIZE)
  {
    ...
    returnZero |= Mkx_Scribe_Cas_NodeKind_One == Mkx_Scribe_Cas_Node_getKind(self->leftOperand) &&
  ...
  )
{
  ...
  Ring1_cast(Mkx_Scribe_Cas_Node*, self)->kind = Mkx_Scribe_Cas_NodeKind_BinaryMinus;
  ...
  Machine_setClassType((Machine_Object*)self, Mkx_Scribe_Cas_BinaryMinusNode_getType());
}
...
{
  Machine_Type* ty = Mkx_Scribe_Cas_BinaryMinusNode_getType();
  ...
  Mkx_Scribe_Cas_BinaryMinusNode* self = Ring1_cast(Mkx_Scribe_Cas_BinaryMinusNode*,
