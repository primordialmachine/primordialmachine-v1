#if !defined(RING1_INTRINSIC_ADD_H_INCLUDED)
...
// https://documentation.primordialmachine.com/ring1-library/intrinsic-library/Ring1_Intrinsic_add
...
#endif // RING1_INTRINSIC_ADD_H_INCLUDED
