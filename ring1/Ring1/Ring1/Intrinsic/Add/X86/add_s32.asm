...
; char __fastcall Ring1_Intrinsic_Add_X86_add_s32(int32_t x, int32_t y, int32_t *z)
; See README.md for more information.
@Ring1_Intrinsic_Add_X86_add_s32@12 PROC
    ...
    RET                       ; RETURN
@Ring1_Intrinsic_Add_X86_add_s32@12 ENDP
