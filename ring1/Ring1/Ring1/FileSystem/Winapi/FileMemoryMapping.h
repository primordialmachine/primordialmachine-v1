...
#if !defined(RING1_FILESYSTEM_WINAPI_FILEMEMORYMAPPING_H_INCLUDED)
#define RING1_FILESYSTEM_WINAPI_FILEMEMORYMAPPING_H_INCLUDED
...
typedef struct Ring1_FileSystem_Winapi_FileMemoryMapping {
  Ring1_FileSystem_Winapi_FileHandle* fileHandle;
  HANDLE hFileMapping;
  char* bytes;
  size_t numberOfBytes;
} Ring1_FileSystem_Winapi_FileMemoryMapping; // struct Ring1_FileSystem_Winapi_FileMemoryMapping
...
#endif // RING1_FILESYSTEM_WINAPI_FILEMEMORYMAPPING_H_INCLUDED
